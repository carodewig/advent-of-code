...
class AsteroidField:
    ...
    def unit_test(cls):
        asteroid_map = ".#..#\n.....\n#####\n....#\n...##"
        assert cls.init_from_str(asteroid_map).best_station_location() == (3, 4, 8)

        asteroid_map = "......#.#.\n#..#.#....\n..#######.\n.#.#.###..\n.#..#.....\n..#....#.#\n#..#....#.\n.##.#..###\n##...#..#.\n.#....####"
        assert cls.init_from_str(asteroid_map).best_station_location() == (5, 8, 33)

        asteroid_map = "#.#...#.#.\n.###....#.\n.#....#...\n##.#.#.#.#\n....#.#.#.\n.##..###.#\n..#...##..\n..##....##\n......#...\n.####.###."
        assert cls.init_from_str(asteroid_map).best_station_location() == (1, 2, 35)

        asteroid_map = ".#..#..###\n####.###.#\n....###.#.\n..###.##.#\n##.##.#.#.\n....###..#\n..#.#..#.#\n#..#.#.###\n.##...##.#\n.....#.#.."
        assert cls.init_from_str(asteroid_map).best_station_location() == (6, 3, 41)
